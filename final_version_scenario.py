...
WIND_DATA = 'Input profiles/winddata_NL.txt'
Pv_DATA = 'Input profiles/pv_data_Rotterdam_NL-15min.txt'  # solar data file ########################
load_DATA = 'Input profiles/load_data.txt' #######################
...
if RESULTS_SHOW_TYPE['Finalresults_show']==True:
    ...
    data=pd.read_csv('Output profiles/results.csv')
