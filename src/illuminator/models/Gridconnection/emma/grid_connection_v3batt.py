...
class GridConnectionBatt(ModelConstructor):
    # """
    ...
    def step(self, time: int, inputs: dict = None, max_advance: int = 900):
        ...
        flow2e = input_data.get('flow2e_grid', 0)
        flow2c = input_data.get('eflow2c', 0)  # ecompressor consumption
        fc = input_data.get('p_out_fuelcell_grid', 0)
