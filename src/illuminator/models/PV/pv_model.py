...
class PV_py_model:
    ...
    def __init__(self, panel_data, m_tilt, m_az, cap, output_type:str='power', resolution:int=15) -> None:
        """
        Used in Python based Mosaik simulations as an addition to the pv_mosaik.PvAdapter class.
        ...
        self.m_efficiency_stc : ???
            ???
        self.G_NOCT : ???
            Expressed in W/m2. This is the irradiance that falls on the panel under NOCT conditions
        self.P_STC : ???
            Expressed in Watts. Available in the spec sheet of a module
        self.peak_power : ???
            ???
        self.m_tilt : ???
            ???
