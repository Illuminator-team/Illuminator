...
import jsonpickle
try:
    import Models.Hortwaterstorage.hotwaterstorage_model as hotstorage_model
except ModuleNotFoundError:
    import hotwaterstorage_model as hotstorage_model
else:
    import Models.Hortwaterstorage.hotwaterstorage_model as hotstorage_model
...
class HotWaterTankSimulator(mosaik_api.Simulator):
    ...
    def create(self, num:int, model:str, params:dict=None, init_vals:dict=None, snapshot=None) -> list:
        """
        ...
        for i in range(next_eid, next_eid + num):
            ...
            if params is not None:
                self.models[eid] = hotstorage_model(params, init_vals)
            else:
    ...
    def add_async_request(self, src_id, dest_id, *attr_pairs) -> None:
        """
        Adds new asynchronous request to the `self.async_requests` attribute
...
def get_nested_attr(hwt, name:str):
    """
    Getter for the nested attributes located within the `hwt` parameter
...
def set_nested_attr(hwt, name:str, value) -> None:
    """
    Setter for the nester attributes located within the `hwt` parameter
