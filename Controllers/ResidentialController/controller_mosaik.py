...
try:
    import Controllers.ResidentialController.controller_model as controller_model
except ModuleNotFoundError:
    import ResidentialController.controller_model as controller_model
else:
    import Controllers.ResidentialController.controller_model as controller_model
...
class controlSim(mosaik_api.Simulator):
    def __init__(self) -> None:
        """
        Constructor for the controlSim class with the mosaik_api.Simulator class as its Parent class
