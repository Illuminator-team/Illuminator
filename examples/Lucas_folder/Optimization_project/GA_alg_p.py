...
GA_log_file = "./examples/Lucas_folder/Optimization_project/GA_live_log.csv"
...
def run_ga_p(scenario, scenario_temp_path, output_path, dec_vars_map, n_var, cost_fun, termination, xl, xu):
...
def run_ga(scenario, scenario_temp_path, output_path, dec_vars_map, n_var, cost_fun, termination, xl, xu):
    # print(dec_vars_map)
