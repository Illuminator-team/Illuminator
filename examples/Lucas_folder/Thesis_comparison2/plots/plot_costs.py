...
axs[0].plot(load_dem_tot, label='Total Household Demand', color='blue', linewidth=linewidth)
axs[0].plot(pv_tot, label='PV Generation', color='orange', linewidth=linewidth)
axs[0].plot(grid_use, label='Grid Usage', color='red', linewidth=linewidth)
...
# 2. State of Charge
axs[2].plot(soc, label='Battery SoC', color='black', linewidth=linewidth)
axs[2].set_ylabel('SoC [%]', fontsize=label_font_size)
...
axs[1].plot(price_short, label='Shortage price', linewidth=linewidth)
axs[1].plot(price_surplus, label='Surplus price', linewidth=linewidth)
axs[1].hlines(0.607, 0, len(price_short), color='red', linestyle='--', linewidth=1)
axs[1].hlines(0.333, 0, len(price_short), color='red', linestyle='--', linewidth=1)
axs[1].set_ylabel('Price [€/kWh]', fontsize=label_font_size)
...
axs[1].plot(price_short, label='Shortage price', linewidth=linewidth)
axs[1].plot(price_surplus, label='Surplus price', linewidth=linewidth)
axs[1].hlines(0.117, 0, len(price_short), color='red', linestyle='--', linewidth=1)
axs[1].hlines( 0.111, 0, len(price_short), color='red', linestyle='--', linewidth=1)
axs[1].set_ylabel('Price [€/kWh]', fontsize=label_font_size)
